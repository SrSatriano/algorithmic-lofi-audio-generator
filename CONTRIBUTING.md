...
Obrigado por considerar uma contribuição para **Gerador algorítmico de áudio lo-fi para B-rolls**.

## Como começar

1. Faça um fork do repositório [algorithmic-lofi-audio-generator](https://github.com/SrSatriano/algorithmic-lofi-audio-generator).

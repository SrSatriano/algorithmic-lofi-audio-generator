# Arquitetura — Gerador algorítmico de áudio lo-fi para B-rolls

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Detecção de cenas + geração por segmento BPM.
...
| Geração | Geração por segmento |
| Mix | Mix alinhado |
| CLI | CLI vídeo→áudio |
| Documentação | Documentação de espectrograma |
